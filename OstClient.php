...
class OstClient extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_client.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_client.view_dir', $this->getPath() . '/Resources/views/');
